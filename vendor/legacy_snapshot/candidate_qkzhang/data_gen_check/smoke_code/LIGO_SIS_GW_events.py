...
# 【新增】全局保存路径配置
# ==========================================
SAVE_DIR = "/root/autodl-tmp/qkzhang/data_gen_check/smoke_data/LIGO_SIS_data"
...
for i in range(len(lensed_source_params) // 2):
    ...
    for j, ifo in enumerate(ifos):
        ...
        # 截断 ringdown 后信号
        # 更稳妥：基于对齐后的 target_index 来截断，而不是原 t_array
