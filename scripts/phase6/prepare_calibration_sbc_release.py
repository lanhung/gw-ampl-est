#!/usr/bin/env python3
"""Create a non-authorizing calibration/SBC materialization release packet."""
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    parser.add_argument("--terminal-probe-authorization", type=Path, required=True)
    ...
    if arguments.output.exists():
        raise FileExistsError("calibration/SBC release packet already exists")
    packet = build_calibration_sbc_materialization_release_packet(
