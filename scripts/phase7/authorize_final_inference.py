#!/usr/bin/env python3
"""Promote an exact final-inference packet after delegated review."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--delegated-review",
        type=Path,
        default=Path("results/phase7/final_inference_review.json"),
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("configs/execution/phase7_final_inference_authorization.yaml"),
    )
